...
from visualex.storage.retriever.models import EXPERT_SOURCE_TYPES, get_source_types_for_expert
...
async def run_query_with_full_tracing(
    ...
    from visualex import LegalKnowledgeGraph
    ...
    from visualex.experts.base import ExpertContext
    from visualex.tools import SemanticSearchTool, GraphSearchTool, ArticleFetchTool
    from visualex.storage.retriever import GraphAwareRetriever, RetrieverConfig
    ...
    # Connect to KG
    from visualex.core.legal_knowledge_graph import MerltConfig
