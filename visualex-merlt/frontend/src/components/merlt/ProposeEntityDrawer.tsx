 ...
 * ====================
 *
 * Drawer laterale per proporre una nuova entità al Knowledge Graph MERL-T.
 * Sostituisce ProposeEntityModal per mantenere visibile l'articolo durante la proposta.
...
export function ProposeEntityDrawer({
  isOpen,
  onClose,
  onSuccess,
  articleUrn,
