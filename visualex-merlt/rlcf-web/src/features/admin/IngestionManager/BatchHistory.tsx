    ...
    return (
      <Card>
        <CardContent className="p-12 text-center" role="status">
          ...
          <p className="text-slate-600">Loading batch history...</p>
          <span className="sr-only">Loading batch history</span>
        </CardContent>
      </Card>
    );
  }
                          ...
                          <div className="p-4 space-y-4">
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                                ...
                                <div>
                                  <span className="text-slate-600">BrocardiInfo:</span>
                                  <div>{batch.config.include_brocardi ? 'Yes' : 'No'}</div>
                                </div>
                                <div>
                                  <span className="text-slate-600">Dry Run:</span>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-white p-3 rounded border">
                                  <div className="flex items-center mb-2">
                                    <Database className="h-4 w-4 text-purple-600 mr-2" aria-hidden="true" />
                                ...
                                <div className="bg-white p-3 rounded border">
                                  <div className="flex items-center mb-2">
                                    <GitBranch className="h-4 w-4 text-blue-600 mr-2" aria-hidden="true" />
                            ...
                            <div className="flex justify-end space-x-2">
                              <Button variant="outline" size="sm" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">
