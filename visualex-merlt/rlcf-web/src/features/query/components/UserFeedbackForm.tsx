    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <MessageSquarePlus className="w-5 h-5 text-blue-400" aria-hidden="true" />
          Feedback Utente
        </CardTitle>
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" role="form" aria-label="Feedback utente">
          {/* Star Rating */}
          <div className="space-y-2">
            ...
            {rating === 0 && (
              <p className="text-xs text-red-400" role="alert">Seleziona un rating per procedere</p>
            )}
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-3 p-3 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors cursor-pointer group">
                <input
                  type="checkbox"
                  {...register('categories.accuracy')}
                  disabled={isPending}
                  className="w-4 h-4 text-blue-600 bg-slate-700 border-slate-600 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 cursor-pointer"
                />
