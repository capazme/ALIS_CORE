    ...
    <div className="border border-slate-700 rounded-lg p-4 bg-slate-800/50">
      ...
      <div className="flex items-start justify-between gap-4 mb-3">
        <div className="flex-1">
          ...
          <p className="text-xs text-slate-500">{supportConfig.description}</p>
        </div>
      </div>
      ...
      {interpretation.reasoning && (
        <div>
          <button
            ...
            className="flex items-center gap-2 text-sm text-blue-400 hover:text-blue-300 transition-colors mb-2 min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
          >
            <ChevronDown
          ...
          {isExpanded && (
            <div className="p-3 bg-slate-900/70 rounded-lg border border-slate-700">
              ...
              <p className="text-sm text-slate-300 leading-relaxed">{interpretation.reasoning}</p>
            </div>
          )}
        </div>
      )}
