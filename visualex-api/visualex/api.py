...
from .config import Settings, HISTORY_LIMIT, RATE_LIMIT, RATE_LIMIT_WINDOW
from .models.norma import Norma, NormaVisitata
from .utils.logging_config import configure_logging, log_request
from .exceptions import (
    VisuaLexError, ValidationError, ResourceNotFoundError, 
    RateLimitExceededError, get_exception_for_status
)
from .scrapers.brocardi import BrocardiScraper
from .scrapers.normattiva import NormattivaScraper
from .scrapers.eurlex import EurlexScraper
from .scrapers.pdfextractor import PDFExtractor, cleanup_browser_pool
from .utils.sys_op import WebDriverManager
from .utils.urngenerator import complete_date_or_parse_async, urn_to_filename
from .utils.treextractor import get_tree
from .utils.text_op import format_date_to_extended, parse_article_input
from .utils.cache_warmup import warmup_cache_background
from .utils.cache_manager import get_cache_manager
from .utils.map import extract_codice_details
import os
...
class NormaController:
    ...
    async def create_norma_visitata_from_data(self, data):
        ...
        if annex_value is None:
            from .utils.map import NORMATTIVA_URN_CODICI
