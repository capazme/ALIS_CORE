...
// Routes
// IMPORTANT: MERL-T routes MUST be before other /api routes to avoid
// authentication middleware in those routes intercepting /api/merlt/* requests
...
║  - MERL-T:  http://localhost:${config.port}/api/merlt/* ${config.merlt.enabled ? '✓' : '✗'}       ║
╚═══════════════════════════════════════════════════════════╝
  `);
});
