...
import { PipelineMonitoringDashboard } from '../components/features/merlt/monitoring';
import { AcademicDashboard } from '../components/features/merlt/dashboard';

type AdminTab = 'users' | 'feedback' | 'environments' | 'pipeline' | 'merlt';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 isolate">
        ...
        {/* ==================== MERL-T DASHBOARD TAB ==================== */}
        {activeTab === 'merlt' && (
          <AcademicDashboard className="mt-0" />
        )}
      </main>
