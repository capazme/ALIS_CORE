...
import { BookOpen, Search, Folder, Clock, Moon, Sun, Settings, Sparkles, Globe, LogOut, Shield, Landmark, Keyboard, User, Scale } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <nav id="tour-sidebar" className="flex-1 flex flex-col items-center py-4 gap-3 md:gap-2">
        ...
        <NavItem to="/bulletin" icon={Landmark} label="Forum" onClick={closeMobile} />
