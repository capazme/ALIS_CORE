...
class MockSemanticSearchTool(BaseTool):
    ...
    def parameters(self) -> List[ToolParameter]:
        return [
            ...
            ToolParameter("source_types", ParameterType.ARRAY, "Source types filter", required=False),
        ]

    async def execute(self, query: str, top_k: int = 5, expert_type: str = None, source_types: List[str] = None) -> ToolResult:
