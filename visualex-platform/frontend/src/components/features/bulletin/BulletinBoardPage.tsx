...
import {
  ...
  Package, Lightbulb, Inbox, Send, Check, X as XIcon, AlertCircle, Landmark,
  Network,
} from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400 mt-1">
            Condividi ambienti e collabora con la community
          </p>
        </div>
        {activeTab !== 'graph' && (
          <button
          ...
          fallback={
            <div className="text-center py-12">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Il plugin MERLT non è caricato o non è disponibile per questo utente.
              </p>
            </div>
          }
        />
